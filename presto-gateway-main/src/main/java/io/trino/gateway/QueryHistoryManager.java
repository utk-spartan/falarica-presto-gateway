...
import io.trino.gateway.persistence.QueryDetail;
import io.trino.gateway.persistence.QueryDetails2;
import io.trino.gateway.persistence.dao.ExecutingQuery;
...
import static io.trino.gateway.clustermonitor.PullBasedPrestoClusterMonitor.CLUSTER_CONNECT_TIMEOUT_SECONDS;
import static io.trino.gateway.clustermonitor.PullBasedPrestoClusterMonitor.LOGIN_PATH;
import static io.trino.gateway.clustermonitor.PullBasedPrestoClusterMonitor.setSSLcontext;
