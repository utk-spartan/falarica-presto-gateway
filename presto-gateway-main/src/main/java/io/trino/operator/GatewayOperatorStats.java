...
@Immutable
public class GatewayOperatorStats
{
    ...
    public OperatorStats add(GatewayOperatorStats... operators)
    {
        return add(ImmutableList.copyOf(operators));
    }

    public OperatorStats add(Iterable<GatewayOperatorStats> operators)
    {
        ...
        for (GatewayOperatorStats operator : operators) {
