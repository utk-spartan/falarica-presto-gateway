 ...
 */
@Immutable
public class GatewayBasicQueryStats
{
    ...
    public GatewayBasicQueryStats(GatewayQueryStats queryStats)
    {
    ...
    public GatewayBasicQueryStats(QueryStats queryStats)
    {
        this(queryStats.getCreateTime(),
                queryStats.getEndTime(),
                queryStats.getQueuedTime(),
