...
public class GatewayQueryStats
{
    ...
    private final List<GatewayOperatorStats> operatorSummaries;

    @JsonCreator
    public GatewayQueryStats(
            ...
            @JsonProperty("operatorSummaries") List<GatewayOperatorStats> operatorSummaries)
    {
        ...
        this.planningTime = planningTime; //requireNonNull(planningTime, "planningTime is null");
        ...
        this.revocableMemoryReservation = revocableMemoryReservation; //requireNonNull(revocableMemoryReservation, "revocableMemoryReservation is null");
        this.totalMemoryReservation = requireNonNull(totalMemoryReservation, "totalMemoryReservation is null");
        this.peakUserMemoryReservation = requireNonNull(peakUserMemoryReservation, "peakUserMemoryReservation is null");
        this.peakRevocableMemoryReservation = peakRevocableMemoryReservation; //requireNonNull(peakRevocableMemoryReservation, "peakRevocableMemoryReservation is null");
        this.peakTotalMemoryReservation = requireNonNull(peakTotalMemoryReservation, "peakTotalMemoryReservation is null");
        this.peakTaskUserMemory = requireNonNull(peakTaskUserMemory, "peakTaskUserMemory is null");
        this.peakTaskRevocableMemory = peakTaskRevocableMemory; //requireNonNull(peakTaskRevocableMemory, "peakTaskRevocableMemory is null");
        ...
        this.physicalInputDataSize = physicalInputDataSize; //requireNonNull(physicalInputDataSize, "physicalInputDataSize is null");
        ...
        this.physicalInputReadTime = physicalInputReadTime; //requireNonNull(physicalInputReadTime, "physicalInputReadTime is null");

        this.internalNetworkInputDataSize = internalNetworkInputDataSize; //requireNonNull(internalNetworkInputDataSize, "internalNetworkInputDataSize is null");
        ...
        this.physicalWrittenDataSize = physicalWrittenDataSize; //requireNonNull(physicalWrittenDataSize, "physicalWrittenDataSize is null");
    ...
    public long getWrittenPositions()
    {
        return operatorSummaries.stream()
                ...
                .mapToLong(GatewayOperatorStats::getInputPositions)
                .sum();
    }
    ...
    @JsonProperty
    public List<GatewayOperatorStats> getOperatorSummaries()
    {
